$( document ).ready(function() {
    ...
    $(".col-sm-12").addClass("panel-default");
    ...
    /* ---------------------------------------------------------- */
    $(".memitem").removeClass('memitem').addClass('dox-memitem');
    $(".memproto").removeClass('memproto').addClass('dox-memproto');
    $(".memdoc").removeClass('memdoc').addClass('dox-memdoc');
    $("span.mlabel").removeClass('mlabel').addClass('dox-mlabel');
    $("table.memberdecls").removeClass('memberdecls').addClass('dox-memberdecls');
    $("[class^=memitem]").removeClass('memitem').addClass('dox-memitem');
    $("span.mlabels").removeClass('mlabels').addClass('dox-mlabels');
    $("table.mlabels").removeClass('mlabels').addClass('dox-mlabels');
    $("td.mlabels-right").removeClass('mlabels-right').addClass('dox-mlabels-right');
    $(".navpath").removeClass('navpath').addClass('dox-navpath');
    $("li.navelem").removeClass('navelem').addClass('dox-navelem');
    ...
    if( $('#details + .groupheader')[ 0 ] )
    {
        var detail_header = $('#details + .groupheader');
        var detail_text = $('#details + .groupheader + .textblock');
     
        detail_header.remove();
        detail_text.detach();
        $('.contents > p:first-of-type').replaceWith( detail_text );
    }
});
