...
Module['FS_createPath']('/data', 'pause_button', true, true);
Module['FS_createPath']('/data', 'ivorium', true, true);
Module['FS_createPath']('/data/ivorium', 'fonts', true, true);
Module['FS_createPath']('/data/ivorium/fonts', 'Roboto-Bold', true, true);
Module['FS_createPath']('/data/ivorium/fonts', 'DejaVuSans-Bold', true, true);
Module['FS_createPath']('/data/ivorium/fonts', 'DejaVuSansMono', true, true);
Module['FS_createPath']('/data/ivorium/fonts', 'urw_gothic_l_book', true, true);
Module['FS_createPath']('/data/ivorium', 'LumaUI', true, true);
Module['FS_createPath']('/data/ivorium/LumaUI', 'LumaScroller', true, true);
Module['FS_createPath']('/data/ivorium/LumaUI', 'GenericButton', true, true);
Module['FS_createPath']('/data/ivorium', 'shaders', true, true);
Module['FS_createPath']('/data/ivorium', 'generic', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 758, "filename": "/data/box.png"}, {"start": 758, "audio": 0, "end": 4793, "filename": "/data/.rctools_index"}, {"start": 4793, "audio": 0, "end": 5432, "filename": "/data/ray.png"}, {"start": 5432, "audio": 0, "end": 10342, "filename": "/data/metadata.json"}, {"start": 10342, "audio": 0, "end": 10982, "filename": "/data/ray_red.png"}, {"start": 10982, "audio": 0, "end": 11911, "filename": "/data/player.png"}, {"start": 11911, "audio": 0, "end": 12505, "filename": "/data/pause_button/xcf.info"}, {"start": 12505, "audio": 0, "end": 13594, "filename": "/data/pause_button/pause.png"}, {"start": 13594, "audio": 0, "end": 17962, "filename": "/data/pause_button/restart.png"}, {"start": 17962, "audio": 0, "end": 22089, "filename": "/data/pause_button/highlight.png"}, {"start": 22089, "audio": 0, "end": 32085, "filename": "/data/pause_button/base.png"}, {"start": 32085, "audio": 0, "end": 34518, "filename": "/data/pause_button/play.png"}, {"start": 34518, "audio": 0, "end": 34811, "filename": "/data/ivorium/empty.png"}, {"start": 34811, "audio": 0, "end": 900206, "filename": "/data/ivorium/fonts/Roboto-Bold/msdf.png"}, {"start": 900206, "audio": 0, "end": 950372, "filename": "/data/ivorium/fonts/Roboto-Bold/font.index"}, {"start": 950372, "audio": 0, "end": 1877934, "filename": "/data/ivorium/fonts/DejaVuSans-Bold/msdf.png"}, {"start": 1877934, "audio": 0, "end": 1928246, "filename": "/data/ivorium/fonts/DejaVuSans-Bold/font.index"}, {"start": 1928246, "audio": 0, "end": 2719591, "filename": "/data/ivorium/fonts/DejaVuSansMono/msdf.png"}, {"start": 2719591, "audio": 0, "end": 2770205, "filename": "/data/ivorium/fonts/DejaVuSansMono/font.index"}, {"start": 2770205, "audio": 0, "end": 3265519, "filename": "/data/ivorium/fonts/urw_gothic_l_book/msdf.png"}, {"start": 3265519, "audio": 0, "end": 3306428, "filename": "/data/ivorium/fonts/urw_gothic_l_book/font.index"}, {"start": 3306428, "audio": 0, "end": 3306667, "filename": "/data/ivorium/LumaUI/LumaScroller/xcf.info"}, {"start": 3306667, "audio": 0, "end": 3309171, "filename": "/data/ivorium/LumaUI/LumaScroller/overlap.png"}, {"start": 3309171, "audio": 0, "end": 3309611, "filename": "/data/ivorium/LumaUI/GenericButton/xcf.info"}, {"start": 3309611, "audio": 0, "end": 3310464, "filename": "/data/ivorium/LumaUI/GenericButton/ready.png"}, {"start": 3310464, "audio": 0, "end": 3311404, "filename": "/data/ivorium/LumaUI/GenericButton/activation.png"}, {"start": 3311404, "audio": 0, "end": 3312280, "filename": "/data/ivorium/LumaUI/GenericButton/hover.png"}, {"start": 3312280, "audio": 0, "end": 3313102, "filename": "/data/ivorium/LumaUI/GenericButton/base.png"}, {"start": 3313102, "audio": 0, "end": 3313877, "filename": "/data/ivorium/shaders/UniversalShader.gl.vert"}, {"start": 3313877, "audio": 0, "end": 3328434, "filename": "/data/ivorium/shaders/UniversalShader.gl.frag"}, {"start": 3328434, "audio": 1, "end": 3352238, "filename": "/data/ivorium/generic/test.ogg"}, {"start": 3352238, "audio": 0, "end": 3420303, "filename": "/data/ivorium/generic/stone.png"}, {"start": 3420303, "audio": 0, "end": 3420893, "filename": "/data/ivorium/generic/white.png"}], "remote_package_size": 3420893, "package_uuid": "bac6f854-5994-4a8f-ab25-c6ef6691887d"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 2644128,
    DYNAMIC_BASE = 7887008,
    DYNAMICTOP_PTR = 2643968;
...
var INITIAL_TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 65536000;if (!Object.getOwnPropertyDescriptor(Module, 'TOTAL_MEMORY')) Object.defineProperty(Module, 'TOTAL_MEMORY', { configurable: true, get: function() { abort('Module.TOTAL_MEMORY has been replaced with plain INITIAL_TOTAL_MEMORY') } });
...
var ASM_CONSTS = {
  91512: function() {var canvas = Module['canvas']; var devicePixelRatio = window.devicePixelRatio || 1; canvas.width = canvas.clientWidth * devicePixelRatio; canvas.height = canvas.clientHeight * devicePixelRatio;},  
 91737: function() {var canvas = Module['canvas']; return canvas.width;},  
 91795: function() {var canvas = Module['canvas']; return canvas.height;},  
 91854: function() {var canvas = Module['canvas']; var devicePixelRatio = window.devicePixelRatio || 1; var width = canvas.clientWidth * devicePixelRatio; var height = canvas.clientHeight * devicePixelRatio; if (width != canvas.width || height != canvas.height) { canvas.width = width; canvas.height = height; return 1; } else { return 0; }}
};
...
var real_dynCall_iji = asm["dynCall_iji"];
asm["dynCall_iji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iji.apply(null, arguments);
};

var real_dynCall_jji = asm["dynCall_jji"];
asm["dynCall_jji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jji.apply(null, arguments);
};
...
var real_dynCall_iiiiiiiidii = asm["dynCall_iiiiiiiidii"];
asm["dynCall_iiiiiiiidii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iiiiiiiidii.apply(null, arguments);
};

var real_dynCall_iiiiiiiiidii = asm["dynCall_iiiiiiiiidii"];
asm["dynCall_iiiiiiiiidii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iiiiiiiiidii.apply(null, arguments);
};
...
var dynCall_iiiiiiiidii = Module["dynCall_iiiiiiiidii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiiiidii"].apply(null, arguments)
};

var dynCall_iiiiiiiiidii = Module["dynCall_iiiiiiiiidii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiiiiidii"].apply(null, arguments)
};
